...
const API_key="1390c5bd330b3b829d0eb8d33c0e7832"; //API key for OpenweatherMap API
...
function getCityCoordinates() {
    const cityName = cityInput.value.trim();//gget user enter city and rmove extra spaces

    ...
    <div class="container py-5">
        <div class="row justify-content-start">
            <div class="col-lg-8 text-center text-lg-start">
                ...
                <a href="{{url('about')}}" class="btn btn-secondary py-md-3 px-md-5">About Us</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6 pb-5">
                <div class="mb-3 pb-2">
                    ...
                    <h1 class="display-5">We are here to help farmer to earn Profit</h1>
                </div>
        ...
        <div class="row g-5">
            <div class="col-lg-3">
                <div class="text-white mb-5">
                    ...
                    <h4 class="text-white">Digital Farming</h4>
                ...
                <div class="text-white">
                    ...
                    <h4 class="text-white">Farming Consultant</h4>
                    <p class="mb-0">Labore justo vero ipsum sit clita erat lorem magna clita</p>
                </div>
            </div>
            <div class="col-lg-6">
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="mx-auto text-center mb-5" style="max-width: 500px;">
            ...
            <h1 class="display-5">Our Professionals</h1>
        </div>
        <div class="row g-5">
